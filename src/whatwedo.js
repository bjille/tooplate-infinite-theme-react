    ...
    return (
        <section id="whatwedo" class="tm-section-pad-top">
            ...
            <div class="container">
                ...
                <div class="row tm-content-box">
                    <div class="col-lg-1">
                        {/* <FontAwesomeIcon icon={faChartBar} className='far fa-3x  text-center tm-icon' flip="horizontal" rotation={270} /> */}
                ...
                <div class="row tm-content-box">
                    ...
                    <div class="col-lg-5">
                        <div class="tm-intro-text-container">
                            ...
                            <p class="mb-4 tm-intro-text">
                                You can change <a href="https://fontawesome.com/icons?d=gallery">Font Awesome icons</a> by either <b><em>fas or far</em></b> in the HTML codes. For Examples:{"\n"}
