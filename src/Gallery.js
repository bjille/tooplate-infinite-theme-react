              ...
              <div className="grid tm-gallery">
                <a href={galleryImg01}>
                  <figure className="effect-honey tm-gallery-item">
                    <img src={galleryImg01} alt="" className="img-fluid" />
                    <figcaption>
                      <h2>
                        <i>
                ...
                <a href={galleryImg02}>
                  <figure className="effect-honey tm-gallery-item">
                    <img src={galleryImg02} alt="" className="img-fluid" />
                    <figcaption>
                      <h2>
                        <i>
                ...
                <a href={galleryImg03}>
                  <figure className="effect-honey tm-gallery-item">
                    <img src={galleryImg03} alt="" className="img-fluid" />
                    <figcaption>
                      <h2>
                        <i>
                ...
                <a href={galleryImg04}>
                  <figure className="effect-honey tm-gallery-item">
                    <img src={galleryImg04} alt="" className="img-fluid" />
                    <figcaption>
                      <h2>
                        <i>
                ...
                <a href={galleryImg05}>
                  <figure className="effect-honey tm-gallery-item">
                    <img src={galleryImg05} alt="" className="img-fluid" />
                    <figcaption>
                      <h2>
                        <i>
                ...
                <a href={galleryImg06}>
                  <figure className="effect-honey tm-gallery-item">
                    <img src={galleryImg06} alt="" className="img-fluid" />
                    <figcaption>
                      <h2>
                        <i>
